...
parser.add_argument('--data', type=str, default='/nas/datasets/IMAGENET2012/', help='path to dataset') # deleted metavar=DIR
parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',help='number of data loading workers (default: 25)')
...
parser.add_argument('--save', default='/nas/home/tgiannilias/ABCPruner_Experiments/ABCPruner_Experiments/New_Experiments/rethinking-network-pruning/Group_Convolutions/Saved_Models/', type=str, metavar='PATH', help='path to save prune model (default: current directory)')
...
def save_checkpoint(state, is_best):
    ...
    if is_best:
        shutil.copyfile(os.path.join(args.save, 'ResNet34_Separable_Groups4.pth.tar'), os.path.join(args.save, 'Best_ResNet34_Separable_Groups4.pth.tar'))
