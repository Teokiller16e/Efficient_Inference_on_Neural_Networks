...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    #return nn.Conv2d(in_channels=in_planes, out_channels=out_planes, kernel_size=3, stride=stride, padding=1, bias=False, groups=number_of_groups)
